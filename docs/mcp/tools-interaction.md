...
> **Source:** [playwright.dev/mcp/tools-interaction](https://playwright.dev/mcp/tools-interaction)
...
**Take a snapshot first**, find the element's `[ref=...]` tag, then pass that ref to the interaction tool.
