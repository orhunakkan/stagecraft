...
- `example-test-1.png` — an auto-generated name of the snapshot. Alternatively you can specify snapshot name as the first argument of the `toHaveScreenshot()` method: `await expect(page).toHaveScreenshot('landing.png');`
...
| What              | How                                                   |
| ----------------- | ----------------------------------------------------- |
| Take screenshot   | `await expect(page).toHaveScreenshot()`               |
| Named screenshot  | `await expect(page).toHaveScreenshot('name.png')`     |
| Update baselines  | `npx playwright test --update-snapshots`              |
| Max pixel diff    | `toHaveScreenshot({ maxDiffPixels: 100 })`            |
| Custom stylesheet | `toHaveScreenshot({ stylePath: './screenshot.css' })` |
| Text snapshot     | `expect(text).toMatchSnapshot('file.txt')`            |
