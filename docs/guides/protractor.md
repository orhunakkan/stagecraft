...
> **Source:** [playwright.dev/docs/protractor](https://playwright.dev/docs/protractor)
...
3. Playwright Test is given a `page` as one of its parameters — one of the many useful fixtures
...
Make sure you have `protractor` installed in your `package.json`, then use the polyfill function:
...
If you don't want to keep a version of Protractor around, you can also use this simpler approach (only works for Angular 2+):
