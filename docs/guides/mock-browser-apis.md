...
> **Source:** [playwright.dev/docs/mock-browser-apis](https://playwright.dev/docs/mock-browser-apis)
  ...
  await page.addInitScript(() => {
    ...
    class BatteryMock {
      ...
      addEventListener(eventName, listener) {
        if (eventName === 'chargingchange') this._chargingListeners.push(listener);
