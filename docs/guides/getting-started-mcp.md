# 🔗 Playwright — Getting Started MCP

> **Source:** [playwright.dev/docs/getting-started-mcp](https://playwright.dev/docs/getting-started-mcp)
...
Click one of the buttons below to install directly. Or install via the VS Code CLI:
...
Go to Cursor Settings → MCP → Add new MCP Server and use command type with `npx @playwright/mcp@latest`.
