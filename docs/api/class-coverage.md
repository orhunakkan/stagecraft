...
> **Source:** [playwright.dev/docs/api/class-coverage](https://playwright.dev/docs/api/class-coverage)
...
- `options` Object (optional)
  - `reportAnonymousScripts` boolean (optional) — Whether anonymous scripts generated by the page should be reported. Defaults to `false`.
  - `resetOnNavigation` boolean (optional) — Whether to reset coverage on every navigation. Defaults to `true`.
...
- `source` string (optional) — Script content, if applicable.
