# 🖱️ Playwright — Interaction

> **Source:** [playwright.dev/agent-cli/commands-interaction](https://playwright.dev/agent-cli/commands-interaction)
...
| --------------- | ------------------------------- |
| Click           | `click <ref>`                   |
| Right-click     | `click <ref> right`             |
| Double-click    | `dblclick <ref>`                |
| Fill input      | `fill <ref> <text>`             |
| Fill + submit   | `fill <ref> <text> --submit`    |
| Type            | `type <text>`                   |
| Select dropdown | `select <ref> <value>`          |
| Check/uncheck   | `check <ref>` / `uncheck <ref>` |
| Hover           | `hover <ref>`                   |
| Drag & drop     | `drag <startRef> <endRef>`      |
