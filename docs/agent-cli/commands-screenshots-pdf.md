...
> **Source:** [playwright.dev/agent-cli/commands-screenshots-pdf](https://playwright.dev/agent-cli/commands-screenshots-pdf)
...
See [Snapshots](snapshots.md) for details on the format and usage.
...
| Screenshot element     | `screenshot [ref]`        |
| Full page screenshot   | `screenshot --full-page`  |
| Custom filename        | `screenshot --filename=f` |
| Export PDF             | `pdf --filename=f`        |
