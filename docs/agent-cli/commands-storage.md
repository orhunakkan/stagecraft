# 💾 Playwright — Storage & Authentication

> **Source:** [playwright.dev/agent-cli/commands-storage](https://playwright.dev/agent-cli/commands-storage)
...
| What           | How                                        |
| -------------- | ------------------------------------------ |
| Save state     | `state-save [filename]`                    |
| Load state     | `state-load <filename>`                    |
| List cookies   | `cookie-list`                              |
| Set cookie     | `cookie-set <name> <value>`                |
| Clear cookies  | `cookie-clear`                             |
