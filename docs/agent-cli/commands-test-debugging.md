...
> **Source:** [playwright.dev/agent-cli/commands-test-debugging](https://playwright.dev/agent-cli/commands-test-debugging)
...
| What                     | How                               |
| ------------------------ | --------------------------------- |
| Start test in debug mode | `npx playwright test --debug=cli` |
| Attach to session        | `attach <session-name>`           |
| Resume execution         | `resume`                          |
| Step over                | `step-over`                       |
| Set breakpoint           | `pause-at file.ts:line`           |
| Inspect state            | `snapshot`, `console`, `network`  |
| Record trace             | `tracing-start` / `tracing-stop`  |
