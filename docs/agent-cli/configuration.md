...
> **Source:** [playwright.dev/agent-cli/configuration](https://playwright.dev/agent-cli/configuration)
...
| Device emulation   | `--device="iPhone 15"`                        |
| Viewport size      | `--viewport-size=1280x720`                    |
| Proxy              | `--proxy-server=<url> --proxy-bypass=<hosts>` |
