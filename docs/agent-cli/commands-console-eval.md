# 🖥️ Playwright — Console & Eval

> **Source:** [playwright.dev/agent-cli/commands-console-eval](https://playwright.dev/agent-cli/commands-console-eval)
...
| Eval on element | `eval "(el) => expression" ref` |
| Run code        | `run-code <code>`               |
| Run script file | `run-code --filename=script.js` |
