# 👁️ Playwright — Vision Mode

> **Source:** [playwright.dev/agent-cli/vision-mode](https://playwright.dev/agent-cli/vision-mode)
...
| What         | How                                        |
| ------------ | ------------------------------------------ |
| Move mouse   | `mousemove <x> <y>`                        |
| Click        | `mousedown` + `mouseup`                    |
| Right-click  | `mousedown right` + `mouseup right`        |
| Drag         | `mousedown` + `mousemove` + `mouseup`      |
| Scroll       | `mousewheel <dx> <dy>`                     |
| Screenshot   | `screenshot --filename=<name>.png`         |
| **Best for** | Canvas, maps, custom widgets without ARIA  |
| **Default**  | Use refs from snapshots for standard pages |
