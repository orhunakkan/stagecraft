...
> **Source:** [playwright.dev/agent-cli/commands-video-recording](https://playwright.dev/agent-cli/commands-video-recording)
...
| What            | How                                                   |
| --------------- | ----------------------------------------------------- |
| Start recording | `video-start [filename]`                              |
| Add chapter     | `video-chapter <title>`                               |
| Stop recording  | `video-stop`                                          |
| Custom size     | `video-start --size=800x600`                          |
| Auto-record     | Config `saveVideo` or env `PLAYWRIGHT_MCP_SAVE_VIDEO` |
