# 🔄 Playwright — Sessions & Dashboard

> **Source:** [playwright.dev/agent-cli/sessions](https://playwright.dev/agent-cli/sessions)
...
| What               | How                                |
| ------------------ | ---------------------------------- |
| Named session      | `-s=<name> <command>`              |
| Persistent profile | `--persistent`                     |
| Custom profile     | `--profile=<path>`                 |
| List sessions      | `playwright-cli list`              |
| Close session      | `playwright-cli -s=<name> close`   |
| Force kill all     | `playwright-cli kill-all`          |
| Save state         | `playwright-cli state-save <file>` |
| Load state         | `playwright-cli state-load <file>` |
| Visual dashboard   | `playwright-cli show`              |
